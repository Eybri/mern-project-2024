...
const OrderShipped = () => {
    const { orders, loading, setOrders } = useOrders('Pending');
                            ...
                            {paginatedOrders.map((order, index) => (
                                <React.Fragment key={order._id}>
                                    <TableRow>
                                        ...
                                        <TableCell style={{ color: statusColors[order.status] }}><i class="bi bi-arrow-clockwise"></i> {order.status}</TableCell>
                                            ...
                                            <Select
                                                ...
                                                >
                                                    ...
                                                    {order.status === "Pending" ? [
                                                        <MenuItem key="ship" value="Shipped" className='text-secondary'>
                                                            <i className="bi bi-arrow-left-right"></i> Ship
                                                        </MenuItem>,
                                                        <MenuItem key="deliver" value="Delivered" className='text-success'>
                                                            <i className="bi bi-truck"></i> Deliver
                                                        </MenuItem>
                                                    ] : null}
                                                    ...
                                                    <MenuItem key="delete" value="Delete" className='text-danger'>
